<template>
    <div>
        ...
        <carousel :per-page=1 :autoplay=true :autoplayTimeout=5000>
            <slide>
                <img src="@/assets/i3week.jpg" >
            </slide>
            <slide>
                <img class="mySlides" src="@/assets/Djam.jpg" >
            </slide>
            <slide>
                <img class="mySlides" src="@/assets/suitcase-members.jpg" >
            </slide>
            <slide>
                <img class="mySlides" src="@/assets/feria.jpg" >
            </slide>
        </carousel>
